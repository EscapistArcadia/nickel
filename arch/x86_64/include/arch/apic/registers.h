...
#define APIC_CONSTANT(value, type)      ((type)(value))
#define APIC_FIELD(value, shift, type)  ((type)((value) << (shift)))
...
#define APIC_TIMER_MODE_SHIFT           17
#define APIC_TIMER_MODE_MASK            0x3
#define APIC_TIMER_MODE_ONE_SHOT        APIC_FIELD(0x0, APIC_TIMER_MODE_SHIFT, uint32_t)
#define APIC_TIMER_MODE_PERIODIC        APIC_FIELD(0x1, APIC_TIMER_MODE_SHIFT, uint32_t)
#define APIC_TIMER_MODE_TSC_DEADLINE    APIC_FIELD(0x2, APIC_TIMER_MODE_SHIFT, uint32_t)

#define APIC_MASK_SHIFT                 16
#define APIC_MASK_MASK                  0x1
#define APIC_MASK_UNMASKED              APIC_FIELD(0x0, APIC_MASK_SHIFT, uint32_t)
#define APIC_MASK_MASKED                APIC_FIELD(0x1, APIC_MASK_SHIFT, uint32_t)

#define APIC_DIVIDE_CONFIG_1            APIC_CONSTANT(0xB, uint32_t)
#define APIC_DIVIDE_CONFIG_2            APIC_CONSTANT(0x0, uint32_t)
#define APIC_DIVIDE_CONFIG_4            APIC_CONSTANT(0x1, uint32_t)
#define APIC_DIVIDE_CONFIG_8            APIC_CONSTANT(0x2, uint32_t)
#define APIC_DIVIDE_CONFIG_16           APIC_CONSTANT(0x3, uint32_t)
#define APIC_DIVIDE_CONFIG_32           APIC_CONSTANT(0x8, uint32_t)
#define APIC_DIVIDE_CONFIG_64           APIC_CONSTANT(0x9, uint32_t)
#define APIC_DIVIDE_CONFIG_128          APIC_CONSTANT(0xA, uint32_t)
